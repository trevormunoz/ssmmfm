    ...
    describe("Model: Item", function() {
        ...
        describe("creation", function() {
            ...
            it('can construct a valid URL given an id', function() {
                ...
                expect(item.url()).to.equal('http://54.165.158.184/menus/item/184236');
            });
        ...
        describe("population from server", function() {
            ...
            beforeEach(function() {
                ...
                this.server.respondWith(
                        "GET",
                        "http://54.165.158.184/menus/item/" + this.fixture._id,
            ...
            describe("fetch", function(){
                it("should make the correct request", function() {
                    ...
                    expect(this.server.requests[0].url).to.equal("http://54.165.158.184/menus/item/" + this.fixture._id);
                });
