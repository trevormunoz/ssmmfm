    ...
    describe("Collection: Cluster", function() {
        ...
        describe("creation", function() {
            ...
            it("should default url property to es search url", function() {
                expect(this.cluster.url).to.equal('http://api.publicfare.org/menus/item/_search');
            });
        ...
        describe("population from server", function() {
            ...
            describe("fetch", function() {
                ...
                it("should make the correct request", function() {
                    ...
                    expect(this.server.requests[0].url).to.equal("http://api.publicfare.org/menus/item/_search");
                });
